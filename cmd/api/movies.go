...
import (
	...
	"github.com/sntegegn/greenlight/internal/data"
	"github.com/sntegegn/greenlight/internal/validator"
)
...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	if data.VaildateMovie(v, movie); !v.Valid() {
		app.failedValidationResponse(w, r, v.Errors)
		return
	}
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.writeJSON(w, envelope{"metadata": metadata, "movies": movies}, http.StatusOK, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
