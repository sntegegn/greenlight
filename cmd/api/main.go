...
import (
	...
	"github.com/sntegegn/greenlight/internal/mailer"
	"github.com/sntegegn/greenlight/internal/vcs"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.selam.net>", "SMTP sender")
