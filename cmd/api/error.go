...
func (app *application) logError(w http.ResponseWriter, r *http.Request, err error) {
	var (
		method = r.Method
...
func (app *application) serverErrorResponse(w http.ResponseWriter, r *http.Request, err error) {
	app.logError(w, r, err)
	msg := "The server encountered a problem and cannot process your request"
...
func (app *application) invalidAuthenticationTokenResponse(w http.ResponseWriter, r *http.Request) {
	...
	message := "invalid or missing authentcation token"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}

func (app *application) authenticationRequiredResponse(w http.ResponseWriter, r *http.Request) {
	message := "you must be authenticated to access this request"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}
